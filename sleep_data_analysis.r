...
# There is not enough evidence to conclude that increasing my daily activity score has a positive effect on the following night's sleep score. More data is required for a more accurate analysis. If additional data does not support a positive correlation, I can think of four possible conclusions: 1) the claim that activity improves sleep quality is bullsh*t, 2) Polar's fitness watch is not very accurate, 3) I am stressing my body too much after having just started working out and the results would be different had I been as active for a longer period of time, or 4) there are some confounding variables, such as the day of the week, that should be taken into account in the analysis.
